...
# install hla*la
COPY HLA-LA-master.zip /usr/local/bin
WORKDIR /usr/local/bin
...
WORKDIR /usr/local/bin
RUN unzip HLA-LA-master.zip
RUN mv /usr/local/bin/HLA-LA-master/* /usr/local/bin/HLA-LA/src/
RUN rm -rf /usr/local/bin/HLA-LA-master
